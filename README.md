...
***
### Setting up and running the R code

1. On your local drive, create a new folder with any name.
2. Download and unzip the dataset from the above link in this newly created folder. Save it with the name _"UCI HAR Dataset"_.
